            ...
            [
                ...
                'submeuns'=>[
                    ...
                    [
                        'name' => 'News',
                        'key' => 'news',
                        'link' => '/admin/Post/News',
                        'permission' => ['add', 'view', 'edit', 'delete'],
                    ],
                    [
                        'name' => 'Opinions',
                        'key' => 'opinions',
                        'link' => '/admin/Post/Opinions',
                        'permission' => ['add', 'view', 'edit', 'delete'],
                    ],
                    [
                        'name' => 'Reviews',
                        'key' => 'reviews',
                        'link' => '/admin/Post/Reviews',
                        'permission' => ['add', 'view', 'edit', 'delete'],
                    ],
...
//        }
        ...
        foreach ($modules as $eachModule) {
            $this->RoleWithPermissions($eachModule, $adminRole); // For Admin
            $this->RoleWithPermissions($eachModule, $superadminRole);
            $this->RoleWithPermissions($eachModule, $userRole);
        }
    }
